...
{\LARGE\bf
\begin{spacing}{1.25}
Homework 1 Data Analysis and Machine Learning
\end{spacing}
}
\end{center}
...
\paragraph{Exercise 3, mean values and variances in linear regression.}
...
Finally, try now to write your own code (you can use the example the nuclear masses in the lecture slides on Regression and Getting started, see \href{{https://compphysics.github.io/MLErasmus/doc/pub/Regression/html/Regression-bs.html}}{\nolinkurl{https://compphysics.github.io/MLErasmus/doc/pub/Regression/html/Regression-bs.html}} and \href{{https://compphysics.github.io/MLErasmus/doc/pub/How2ReadData/html/How2ReadData-bs.html}}{\nolinkurl{https://compphysics.github.io/MLErasmus/doc/pub/How2ReadData/html/How2ReadData-bs.html}}) that reads in the nuclear masses and
